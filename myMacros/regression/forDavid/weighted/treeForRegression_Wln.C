...
void treeForRegression_Wln::Loop()
{
 ...
 outtree->Branch("weight_etaPt", &weight_etaPt_, "weight_etaPt_/F");
   ...
   for (Long64_t jentry=0; jentry<nentries;jentry++) {
	...
	// New for Jet pT Weights
	if (i > 13)
	  weight_etaPt_ = weight_etaPt[i];  
	else: weight_etaPt_ = 1;
	...
	Jet_neHEF_= Jet_neHEF[i];
	Jet_neEmEF_ = Jet_neEmEF[i];
        ...
        Jet_vtx3dL_=Jet_vtx3DVal[i];
        Jet_vtxMass_=Jet_vtxMass[i];
        Jet_vtx3deL_=TMath::Max(0.,Jet_vtx3DSig[i]);
        Jet_vtxNtrk=Jet_vtxNtracks[i];
	Jet_vtxPt_=Jet_vtxPt[i];
