...
*/
   ...
   TMVA::Tools::Instance();
   (TMVA::gConfig().GetIONames()).fWeightFileDir ="weights_ZH_weighted";
   ...
   */
   ...
   TFile * input = new TFile("/exports/uftrig01a/dcurry/data/bbar/13TeV/heppy/v14/trees_for_regression/ZH125_ZH_genJet_weighted.root", "read");
  ...
  // TChain * c = new TChain("tree");
   ...
   TCut mycut = " Jet_mcPt>10 && abs(Jet_mcFlavour)==5 && Jet_pt>15";
  ...
  factory->PrepareTrainingAndTestTree( mycut,
   ...
   if (Use["BDTG"])
     factory->BookMethod( TMVA::Types::kBDT, "BDTG",
			  "!H:!V:NTrees=800:BoostType=Grad:Shrinkage=0.10:MaxDepth=3" );
   // --------------------------------------------------------------------------------------------------
