...
*/
   ...
   TMVA::Tools::Instance();
   (TMVA::gConfig().GetIONames()).fWeightFileDir ="weights_ZH_newSettings1000Trees";
   ...
   //factory->AddVariable( "met_pt", "met_pt", "units", 'F' );
   //factory->AddVariable( "Jet_btagCSV", "Jet_btagCSV", "units", 'F' );
   ...
   /*   TFile *input(0);
   TString fname = "/tigress-hsm/dlopes/Step2_28Feb12/TestBDT24_ZHll115_Fall11.root";
   ...
   */
   ...
   TFile * input = new TFile("/exports/uftrig01a/dcurry/data/bbar/13TeV/heppy/v14/trees_for_regression/ZH125_genJet.root", "read");
   //TFile * input = new TFile("/exports/uftrig01a/dcurry/data/bbar/13TeV/heppy/v14/trees_for_regression/ttbar_genJet.root", "read");
   ...
   //factory->SetWeightExpression( "weight_etaPt", "Regression" );
   
   // Apply additional cuts on the signal and background samples (can be different)
   TCut mycut = "Jet_mcPt>20 && abs(Jet_mcFlavour)==5 && Jet_pt>15 && Jet_btagCSV > 0 && abs(Jet_eta) < 2.4";
   
   // tell the factory to use all remaining events in the trees after training for testing:
   //   factory->PrepareTrainingAndTestTree( mycut, 
   //                                   "nTrain_Regression=0:nTest_Regression=0:SplitMode=Random:NormMode=NumEvents:!V" );
  factory->PrepareTrainingAndTestTree( mycut,
                                       //"nTrain_Regression=220000:nTest_Regression=220000:SplitMode=Random:NormMode=NumEvents:!V" );
				       "nTrain_Regression=0:nTest_Regression=0:SplitMode=Random:NormMode=NumEvents:!V" );
   ...
   if (Use["BDTG"])
     factory->BookMethod( TMVA::Types::kBDT, "BDTG",
			  //"!H:!V:NTrees=200:BoostType=Grad:Shrinkage=0.10:MaxDepth=3" 
			  "!H:!V:NTrees=1000::BoostType=Grad:Shrinkage=0.1:SeparationType=RegressionVariance:UseBaggedGrad:GradBaggingFraction=0.7:nCuts=20:MaxDepth=3:NNodesMax=15"
			  );
   // --------------------------------------------------------------------------------------------------
