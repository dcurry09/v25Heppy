...
DY_list = [ 
    ...
    'DY_1200to2500', 'DY_2500toInf', 'DY_70to100',
...
sample_list1 = ST_list + ['WZ', 'DY_Bjets']

sample_list2 = ['DY_inclusive', 'ttbar', 'ZZ_2L2Q_ext1', 'ZZ_2L2Q_ext2', 'ZZ_2L2Q_ext3'] + signal_list + DY_list + data_list
